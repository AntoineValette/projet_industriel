...
CREATE TABLE IF NOT EXISTS dataset2 (
  ...
  "Column Name Error" REAL,
  "Connection Timeout Error" REAL,
  "Create TABLE Error" REAL,
  "Date Format Error" REAL,
  "Field Size Error" REAL,
  "Guidez Atelier Error" REAL,
  "Index Error (similar to unique index error)" REAL,
  "Object Reference Error" REAL,
  "Other Error" REAL,
  "Pre-Login Error" REAL,
  "Primary Key Error" REAL,
  "SQL Invalid Query Error" REAL,
  "SQL Query Timeout Error" REAL,
  "Time Format Error" REAL,
  "Unique Index Error" REAL,
  "Value #DIV/0! Error" REAL,
  "Value #NAME? Error" REAL,
  "Value #REF! Error" REAL,
  "Value #VALUE! Error" REAL,
  "Web Service Error" REAL,
  "ETL Achats" REAL,
  "ETL BEXT" REAL,
  "ETL Chargement PJ" REAL,
  "ETL GLPI" REAL,
  "ETL Heures Chauffeurs" REAL,
  "ETL JIRA" REAL,
  "ETL KPI ALDI" REAL,
  "ETL Taxation" REAL,
  "ETL Vue Heures Agrégées" REAL,
  "ETL sur ordre" REAL,
  "ETL_API_JWT" REAL,
  "Tous les jours" REAL,
  "Toutes les semaines, le dimanche" REAL,
  "Total_Errors" REAL,
  "nb_operations" REAL,
  "rows_added" REAL,
  "rows_updated" REAL,
